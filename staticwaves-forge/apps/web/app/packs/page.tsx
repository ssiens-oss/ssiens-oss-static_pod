    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6">
            <div className="text-sm text-gray-400 mb-1">Published Packs</div>
        ...
        {/* Pack Presets */}
        <div className="mt-12">
          <h2 className="text-2xl font-bold mb-4">Pre-Configured Packs</h2>
...
function PresetCard({ name, description, assets, price }: {
  name: string
  description: string
  assets: number
  price: number
