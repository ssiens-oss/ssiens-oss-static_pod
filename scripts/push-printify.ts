 ...
 * Reads images from comfyui/output/failed and creates T-shirt and Hoodie products in Printify
 */
...
class PrintifyPusher {
  ...
  constructor() {
    ...
    this.imageDir = process.env.COMFYUI_FAILED_DIR || 'comfyui/output/failed'
  }
